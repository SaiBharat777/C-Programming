 ...
 *
 * Application: c program to demonstrate the use of &(address of) and *(value at address) operator.
 * Brief: Demonstrating the use of &(address of) and *(value at address) operator.
 * Author: Sai Bharat
